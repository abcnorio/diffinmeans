...
Rewrite the integration function used to work multi-threaded and speed up the calculations. Use `logSum` and some other commands to speed up the calculation of the integrals. Another alternative is to use the package Rmpfr.
